...
namespace lgl {
	Rect::Rect(glm::vec2 corner1, glm::vec2 corner2, glm::vec3 color) {
		...
		m_vertexArray = utl::makeUptr<VertexArray>();
		m_vertexBuffer = utl::makeUptr<VertexBuffer>();
		m_bufferLayout = utl::makeUptr<VertexBufferLayout>();

		m_shader = utl::makeUptr<GpuProgram>("Rectangle Shader");
		...
		m_vertexBuffer->setData((utl::cmemptr)&vertexData[0], vertexData.size() * sizeof(glm::vec2));
